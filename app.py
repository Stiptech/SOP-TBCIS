    ...
    st.markdown(
        ...
        <div class="topbar">
            <div class="brand-left">
                <div class="brand-mark">TBCIS</div>
...
def render_sidebar(profile, pages):
    ...
    st.sidebar.markdown(
        """
        <div style="padding:14px;border-radius:18px;background:rgba(255,255,255,0.10);border:1px solid rgba(255,255,255,0.16);">
            <div style="font-size:38px;line-height:1;">🏫</div>
            <div style="font-weight:900;margin-top:8px;">Terang Bangsa</div>
            <div style="font-size:12px;opacity:.86;">Admission System</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
