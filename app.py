...
def inject_css():
    st.markdown(
        ...
        .stDateInput input:hover {
            border-color: #0b6de5 !important;
            box-shadow: 0 0 0 2px rgba(11, 109, 229, 0.10) !important;
        }
        ...
        .stDateInput input:focus {
            border-color: #0b6de5 !important;
            box-shadow: 0 0 0 3px rgba(11, 109, 229, 0.16) !important;
        }
        ...
        .section-card:hover {
            border-color: #c8dbf7;
            box-shadow: 0 16px 38px rgba(11, 65, 140, 0.09);
        }
...
def render_recent_leads(leads):
    ...
    with button_col:
        if st.button("View All →", key="recent_leads_view_all_top", use_container_width=True):
            go_to_page("All Leads")
    ...
    if st.button("View All Leads →", key="recent_leads_view_all_bottom", use_container_width=True):
        go_to_page("All Leads")
